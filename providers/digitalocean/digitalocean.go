...
func (c *ProviderClient) Enabled() bool {
	return c.Session.Providers.DigitalOcean.Enabled
}
...
func (c *ProviderClient) FindHost() ([]byte, error) {
	...
	if os.Getenv("CCI_BACKUP_RESPONSES") == "true" {
		...
		if err = os.WriteFile(fmt.Sprintf("%s/backups/digitalocean_%s_report.json", session.GetConfigRoot("", session.AppName),
