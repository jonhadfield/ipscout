...
func TestEnabled(t *testing.T) {
	...
	pc := &ProviderClient{}
	enabled := true
	pc.Providers.Gcore.Enabled = &enabled
	...
	pc.Providers.Gcore.Enabled = nil
...
func TestPriority(t *testing.T) {
	...
	priority := int32(20)
	pc.Providers.Gcore.OutputPriority = &priority
...
func TestLoadResultsFile(t *testing.T) {
	...
	res, err := providers.LoadResultsFile[HostSearchResult]("testdata/gcore_192_0_2_1_report.json")
	require.NoError(t, err)
	require.Equal(t, netip.MustParsePrefix(testPrefixV4), res.Prefix)
}
...
func TestExtractThreatIndicators(t *testing.T) {
	...
	require.Equal(t, "true", indicators.Indicators["GcoreCDN"])
...
func TestRateHostData(t *testing.T) {
	...
	ratingConfigJSON := `{"providers":{"gcore":{"defaultMatchScore":10.0}}}`
	...
	require.Equal(t, []string{"source is the Gcore CDN"}, result.Reasons)
}
...
func TestRateHostDataNoMatch(t *testing.T) {
	...
	ratingConfigJSON := []byte(`{"providers":{"gcore":{"defaultMatchScore":10.0}}}`)
...
func TestInitialiseAndFindHostOverNetwork(t *testing.T) {
	...
	c := newMockedClient(t, http.StatusOK, []byte("{\"addresses\": [\"192.0.2.1/32\"], \"addresses_v6\": [\"2001:db8::1/128\"]}"))
...
func TestInitialiseNetworkEmptyDocument(t *testing.T) {
	...
	c := newMockedClient(t, http.StatusOK, []byte("{\"addresses\": [], \"addresses_v6\": []}"))
