...
const testHostnameDNSGoogle = "dns.google"
...
func TestShodanHostDNSQuery(t *testing.T) {
	...
	require.Equal(t, []string{testHostnameDNSGoogle}, sr.Hostnames)
	require.Equal(t, "US", sr.CountryCode)
	require.Equal(t, "United States", sr.CountryName)
	require.Equal(t, []string{testHostnameDNSGoogle}, sr.Domains)
	...
	require.Equal(t, []string{testHostnameDNSGoogle}, sr.Data[0].Hostnames)
	require.Equal(t, "2024-04-28T09:18:08.964972", sr.Data[0].Timestamp)
	...
	require.Equal(t, testHostnameDNSGoogle, sr.Data[0].Domains[0])
	...
	require.Equal(t, []string{testHostnameDNSGoogle}, sr.Data[1].Hostnames)
	require.Equal(t, "2024-04-28T12:50:55.650683", sr.Data[1].Timestamp)
	...
	require.Equal(t, testHostnameDNSGoogle, sr.Data[1].Domains[0])
	...
	require.Equal(t, []string{testHostnameDNSGoogle}, sr.Data[2].Hostnames)
	require.Equal(t, "2024-04-28T09:25:24.474444", sr.Data[2].Timestamp)
	...
	require.Equal(t, testHostnameDNSGoogle, sr.Data[2].Domains[0])
