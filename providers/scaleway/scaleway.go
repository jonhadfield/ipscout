...
func (c *ProviderClient) Initialise() error {
	...
	if ok {
		c.Logger.Debug("scaleway provider data found in cache")

		return nil
	}

	c.Logger.Debug("loading scaleway provider data from source")
...
func (c *ProviderClient) loadProviderDataFromCache() (Doc, error) {
	c.Logger.Debug("loading scaleway provider data from cache")
