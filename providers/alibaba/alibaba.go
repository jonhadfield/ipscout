...
func (c *ProviderClient) Initialise() error {
	...
	if ok {
		c.Logger.Debug("alibaba provider data found in cache")

		return nil
	}

	c.Logger.Debug("loading alibaba provider data from source")
...
func (c *ProviderClient) loadProviderDataFromCache() (Doc, error) {
	c.Logger.Debug("loading alibaba provider data from cache")
