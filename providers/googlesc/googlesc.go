...
func (c *ProviderClient) Initialise() error {
	...
	if ok {
		c.Logger.Info("googlesc provider data found in cache")

		return nil
	}

	c.Logger.Info("loading googlesc provider data from source")
...
func (c *ProviderClient) loadProviderDataFromCache() (*googlesc.Doc, error) {
	c.Logger.Info("loading googlesc provider data from cache")
